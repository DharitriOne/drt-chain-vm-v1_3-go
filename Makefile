...
ifndef SANDBOX
	...
	git clone --depth=1 --branch=master https://github.com/DharitriOne/sc-delegation-rs.git ${SANDBOX}/sc-delegation-rs
...
ifndef SANDBOX
	...
	git clone --depth=1 --branch=master https://github.com/DharitriOne/sc-dns-rs.git ${SANDBOX}/sc-dns-rs
