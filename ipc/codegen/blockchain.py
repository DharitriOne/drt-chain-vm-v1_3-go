...
signatures = [
    ...
    HookSignature(name="GetDCDTToken", input=[("address", "[]byte"), ("tokenID", "[]byte"), ("nonce", "uint64")], output=[("result", "*dcdt.DCDigitalToken")], error=True),
...
def generate_messages(args):
    ...
    print("""
        ...
        \"github.com/DharitriOne/dharitri/data/dcdt\"
        )
	""")
...
def generate_repliers(args):
    ...
    print("""
    	import (
	    \"github.com/DharitriOne/drt-chain-vm-go/v1_3/ipc/common\"
        \"github.com/DharitriOne/drt-chain-vm-go/v1_3/vmhost\"
	    \"github.com/DharitriOne/dharitri/data/dcdt\"
	)
	""")
